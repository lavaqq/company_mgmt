...
class LeadQualifiedTable extends BaseWidget
{
    protected static ?string $heading = 'Leads qualifiés';
    ...
    {
        return 'Aucun lead qualifié enregistré';
    }
    ...
    {
        return Lead::query()->where('status', 'qualified');
    }
