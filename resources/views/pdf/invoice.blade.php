...
<body>
    ...
    <section class="informations">
        ...
        <div class="informations__recipient">
            ...
            <p class="text uppercase">{{ $data->deal->lead->company->street }} {{ $data->deal->lead->company->number }}
                {{ $data->deal->lead->company->box ? 'boîte ' . $data->deal->lead->company->box : null }}</p>
            <p class="text uppercase">{{ $data->deal->lead->company->zipcode }} {{ $data->deal->lead->company->city }}
